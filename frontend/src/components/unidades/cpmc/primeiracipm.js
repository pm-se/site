...
export default class primeiracipm extends Component {
  render() {
    return (
      <div className="container div-main center">
        <h1> 1ª Companhia Independente de Polícia Militar </h1>
        ...
        <h5>Contato</h5>
        <br />
        <p>Endereço: Praça da Matriz, s/nº &nbsp;São Cristóvão/SE.</p>
        <p>CEP 49.100-000</p>
        <p>
          Tel.: (79) 3261-4964 / 98867-6867 (Comando) / 98816-6681 (Supervisor)
        </p>
