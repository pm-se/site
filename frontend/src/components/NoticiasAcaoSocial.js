                ...
                <div className="row">
                    ...
                    <div className="col-sm-6 col-md-4 col-lg-4">
                        <figure className="thumbnail">
                            ...
                            />
                            <figcaption className="caption">
                                <h5>Atleta do projeto social A Escola Vai ao Batalhão de Choque intensifica preparação para o Mundial Escolar de Combate Games</h5>
                            </figcaption>
                        </figure>
                    </div>
                    ...
                    <div className="col-sm-6 col-md-4 col-lg-4">
                        <figure className="thumbnail">
                            ...
                            />
                            <figcaption className="caption">
                                <h5>Polícia Militar celebra a formatura 524 estudantes no Programa Educacional de Resistência às Drogas e à Violência (Proerd)</h5>
                            </figcaption>
                        </figure>
                    </div>
