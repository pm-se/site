...
export default class Topo extends React.Component {
    ...
    render() {
        ...
        return (
            <div
                className={`${eVisivel ? div_root.classList.remove(addClass) : div_root.setAttribute('class', addClass)}`}>
                <div className="click-closed"/>
                <header role="banner">
                    <nav className="navbar navbar-default navbar-trans navbar-expand-lg fixed-top" role="navigation">
                                ...
                                <ul className="navbar-nav">
                                    ...
                                    <li className="nav-item dropdown">
                                        ...
                                        >
                                            ...
                                            <Link to="/ex-comandantes_gerais" className="dropdown-item">
                                    ...
                                    <li className="nav-item dropdown">
                                        ...
                                        <div
                                            ...
                                            aria-labelledby="navbarDropdown"
                                        >
                                            <Link to="/como_ingressar" className="dropdown-item">
                                                Como ingressar
                                            </Link>
                                    ...
                                    <li className="nav-item dropdown">
                                        ...
                                        >
                                            ...
                                            <Link to="/aquisicao_armamentos" className="dropdown-item">
